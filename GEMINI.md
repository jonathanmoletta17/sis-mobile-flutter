...
- Regras de seguranca GLPI, preservacao de funcionalidades de producao e proibicoes de mutacao: ver secao "Regras de seguranca GLPI para agentes (fonte unica)" em `AGENTS.md` — nao duplicadas aqui.
