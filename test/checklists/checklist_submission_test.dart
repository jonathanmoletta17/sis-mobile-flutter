...
void main() {
  ...
  test(
    'toTicketContent inclui resposta Checklist=PREVENTIVA quando inicializada pelo defaultValues',
    () {
  ...
  test(
    'toTicketContent inclui CORRETIVA quando preselectedType="CORRETIVA"',
    () {
      final result = _preparer().prepare(
        formId: 50,
        targetId: 341,
  ...
  test(
    'toTicketInput gera payload com name, entities_id, itilcategories_id',
    () {
      final result = _preparer().prepare(
        formId: 50,
        targetId: 341,
  ...
  test(
    'toTicketInput inclui Checklist Programada no nome quando preenchida',
    () {
      final result = _preparer().prepare(
        formId: 50,
        targetId: 341,
      ...
      expect(
        input['name'],
        'Checklist HIDRAULICO ALA RESIDENCIAL - 19-05 as 09:00 CALICA',
      );
    },
  );
